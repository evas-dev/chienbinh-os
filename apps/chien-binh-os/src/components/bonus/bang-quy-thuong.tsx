...
/**
 * Bảng chia quỹ thưởng cuối kỳ theo tỷ lệ EXP.
 *
 * Là một chế độ xem của trang Nhân sự (`/admin?xem=quy-thuong`) chứ không còn
 * là trang riêng — quyền Tổng Tư Lệnh do trang đó chốt. `profile` truyền vào để
 * tô đậm dòng của chính người đang xem.
 */
export async function BangQuyThuong({ profile }: { profile: Tables<"profiles"> }) {
