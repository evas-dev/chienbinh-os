...
/**
 * Xử phạt: form ra quyết định + danh mục mức phạt + sổ ghi án.
 *
 * Là một nửa của trang Thưởng phạt (`/thuong-phat`) chứ không còn là trang
 * riêng — quyền cấp quản lý do trang đó chốt.
 */
export async function KhuXuPhat({ profile }: { profile: Tables<"profiles"> }) {
